                    ...
                    <div className="bg-gradient-to-r from-emerald-950/50 to-gray-900/50 border border-emerald-500/20 rounded-3xl p-8 mb-12">
                        <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-10">
                            ...
                            <div className="flex flex-col gap-2">
                                <p className="text-gray-600 text-xs font-semibold uppercase tracking-wider mb-1">Productos estrella</p>
                                {zone.ingredients.map((ing) => (
                                    <span key={ing} className="text-xs bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 px-3 py-1 rounded-full">
                                        {ing}
                                    </span>
                                ))}
                            </div>
